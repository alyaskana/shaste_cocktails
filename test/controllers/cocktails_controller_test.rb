...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { description: @cocktail.description, directions: @cocktail.directions, image: @cocktail.image, title: @cocktail.title, user_id: @cocktail.user_id } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { description: @cocktail.description, directions: @cocktail.directions, image: @cocktail.image, title: @cocktail.title, user_id: @cocktail.user_id } }
